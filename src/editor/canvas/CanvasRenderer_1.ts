...
//         const x1 = visibleTiles.x;
//         const x2 = visibleTiles.x + visibleTiles.xSize;
//         const y1 = visibleTiles.y;
//         const y2 = visibleTiles.y + visibleTiles.ySize;

//         // Draw vertical lines
//         for (let x = x1; x <= x2; x++) { //this.numTiles; x++) {
//             this._ctx.lineWidth = (2 - x % 2) / this._scale;
//             this._ctx.beginPath();
...
//         for (let y = y1; y <= y2; y++) {
//             this._ctx.lineWidth = (2 - y % 2) / this._scale;
//             this._ctx.beginPath();
...
//                     // New
//                     this.world.getMarkersFromNode(node).forEach((marker) => {
...
//         const xEnd = Math.ceil((visibleGridRect.x + visibleGridRect.width) / this.tileSize);
//         const yEnd = Math.ceil((visibleGridRect.y + visibleGridRect.height) / this.tileSize);
//         const xSize = xEnd - x;
//         const ySize = yEnd - y;
